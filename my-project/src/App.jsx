...
var data = [] 
      ...
      localRides.map((ride) => {
        if (ride.startingPoint==query.startingPoint && ride.endingPoint == query.endingPoint && ride.reservationDate == query.reservationDate && ride.seatsAv >= query.seatsAv  ) {
          data.push(ride)
        }
        return data
  ...
  return (
    <>
    <searchContext.Provider  value={{filterRides}}>
      ...
      <Router>
        <Routes>
          ...
          <Route path='/AllRides' element={<AllRides getOneRide={getOneRide} localRides={localRides}/>}/>
