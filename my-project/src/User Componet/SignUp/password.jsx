...
const Password = () => {
  ...
  return (
    ...
    <div className="max-w-md w-full space-y-8">
     ...
     <Link to="/Login"   className="bg-blue-500 p-2 rounded-tr-lg rounded-br-lg text-white font-semibold hover:bg-blue-800 transition-colors" onClick={userRegister}>Confirm</Link>
    </div>
    </div>
  )
}
