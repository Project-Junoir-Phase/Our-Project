...
const {userData, setCurrentPage} = useContext(UserContext)
  ...
  const handleUpdate = () => {
    axios.put(`http://localhost:3000/Edit/PhoneNum/${userData.user_id}` , {phoneNum}).then((res) => console.log("updated!")).then(() => setCurrentPage("Profile")).catch((err) => console.log(err))
  }
